...
export default function LeafletMapSelector({
  ...
  useEffect(() => {
    ...
    const startLat = initialLatRef.current ?? DEFAULT_LAT;
    const startLng = initialLngRef.current ?? DEFAULT_LNG;
    ...
    if (initialLatRef.current !== null && initialLatRef.current !== undefined && initialLngRef.current !== null && initialLngRef.current !== undefined) {
