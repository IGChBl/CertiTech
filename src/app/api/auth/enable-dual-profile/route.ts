...
export async function POST(request: NextRequest) {
    try {
        ...
        if (body.actionType === "CREATE_TECHNICIAN") {
            ...
            await prisma.technicianProfile.create({
                data: {
                    ...
                    availabilityText,
                    scheduleText,
                    // Conectamos las categorías existentes en tu BD
                    categories: {
            ...
            const derivedFullName = fullUser.name || fullUser.technicianProfile?.displayName || "Usuario CertiTech";
        ...
        await setSessionCookies({
            ...
            activeRole: auth.session.activeRole as any, // Mantiene el modo actual en el que estaba
        });
