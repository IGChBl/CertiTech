...
function getMessageFromStatus(status: string) {
  ...
  if (status === "expired") {
    return {
      ...
      body: "El enlace de verificacion ya expiro. Solicita un nuevo correo de verificacion.",
  ...
  if (status === "missing-token") {
    return {
      ...
      body: "No encontramos un token de verificacion en el enlace.",
      tone: "warning" as const,
    };
  }
  ...
  return {
    ...
    body: "El enlace de verificacion no es valido o ya fue utilizado.",
    tone: "warning" as const,
  };
}
